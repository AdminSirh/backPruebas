 ...
 * @author oguerrero23
 */
public class Incidencias_Ayuda_DiasPermisoDTO {
    ...
    //Atributos de la Tabla Ayuda Dias Permiso
    ...
    public Incidencias_Ayuda_DiasPermisoDTO() {
    }

    public Incidencias_Ayuda_DiasPermisoDTO(LocalDate fecha_inicio, LocalDate fecha_fin, Cat_Incidencias cat_incidencias, Integer trabajador_id, Integer num_dias, String observaciones, String folio, String bis, Integer estatus, Integer estado_incidencia_id, LocalDate fecha_recepcion, LocalDate fecha_emision, String nombre, String apellido_paterno, String apellido_materno, Integer incidencia_id, String origen, Integer periodo_pago_id, Integer parentesco_id, Double monto, LocalDate fecha_evento, LocalDate dia_1, LocalDate dia_2, LocalDate dia_3, LocalDate dia_4, LocalDate dia_5, LocalDate dia_6) {

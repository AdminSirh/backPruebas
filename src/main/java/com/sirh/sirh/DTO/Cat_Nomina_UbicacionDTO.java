...
public class Cat_Nomina_UbicacionDTO implements Serializable{
    @Id
    ...
    public Cat_Nomina_UbicacionDTO() {
        super();
    }

    public Cat_Nomina_UbicacionDTO(Integer id_tipo_nomina_ubicacion, Cat_Tipo_Nomina cat_Tipo_Nomina, Cat_Ubicacion cat_Ubicacion) {

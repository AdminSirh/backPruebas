 ...
 */
@Entity
@Table(name="historico_puestos")
public class Historico_Puesto implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_historico_puesto;
    
    private Integer id_puesto;
    private Integer codigo_puesto;
    private Integer nivel;
    private String puesto;
    private String puesto_oficialia_mayor;
    ...
    public Historico_Puesto() {
    }
    
    public Historico_Puesto(Integer id_historico_puesto, Integer id_puesto, Integer codigo_puesto, Integer nivel, String puesto, String puesto_oficialia_mayor, double sueldo_diario, double sueldo_diario_doble, double sueldo_hora, double sueldo_hora_doble, double sueldo_hora_triple, double sdi_inicial, LocalDate fecha_movimiento, Integer status, double sueldo_mensual, double cantidad_adicional_mensual, String hw_status, String hwx_hora, String autorizacion_oficialia_mayor, Integer num_plazas_autorizadas, Integer autorizadopor_oficialia_mayor, String base_confianza, String clave_RH, double sueldo_quincenal_tabulado, double dif_sueldo_diario, double dif_sueldo_hora, double dif_sueldo_mensual, double dif_cant_adicmens, double isr_mens_prest, double isr_mensual, double cuota_imss, double sueldo_mensual_neto, String codigo_rh, double sueldo_estructura, double sueldoHora7, LocalDate fecha_captura, LocalDate fecha_registro) {
        this.id_historico_puesto = id_historico_puesto;
        this.id_puesto = id_puesto;
        this.codigo_puesto = codigo_puesto;
        this.nivel = nivel;
        this.puesto = puesto;
        this.puesto_oficialia_mayor = puesto_oficialia_mayor;
    ...
    public Integer getId_historico_puesto() {
        return id_historico_puesto;
    }

    public void setId_historico_puesto(Integer id_historico_puesto) {
        this.id_historico_puesto = id_historico_puesto;
    }
    ...
    public String getPuesto_oficialia_mayor() {
        return puesto_oficialia_mayor;
    }

    public void setPuesto_oficialia_mayor(String puesto_oficialia_mayor) {
        this.puesto_oficialia_mayor = puesto_oficialia_mayor;
    }

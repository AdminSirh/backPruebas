...
@Entity
@Table (name = "pagos_2")
public class Pagos_2 {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_2;
    ...
    public Pagos_2(Integer id_pago_2, Trabajador trabajador, Double monto, Integer periodo_aplicacion, Integer anio_aplicacion, Integer puesto_temporal_id, Double sueldo_temporal, Double sueldo_temporal_mensual, LocalDate fecha_registro, Integer taxi_electrico, Double sdi, Cat_Puesto cat_Puesto) {
        this.id_pago_2 = id_pago_2;
    ...
    public Integer getId_pago_2() {
        return id_pago_2;
    }

    public void setId_pago_2(Integer id_pago_2) {
        this.id_pago_2 = id_pago_2;
    }

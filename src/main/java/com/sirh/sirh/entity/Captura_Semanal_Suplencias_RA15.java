 ...
 */
@Entity
@Table(name = "captura_semanal_suplencias_ra_15")
public class Captura_Semanal_Suplencias_RA15 implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_suplencia;
    ...
    public Integer getId_suplencia() {
        return id_suplencia;
    }

    public void setId_suplencia(Integer id_suplencia) {
        this.id_suplencia = id_suplencia;
    }

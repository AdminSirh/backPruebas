...
@Entity
@Table (name="fonacot_cuentas_por_cobrar")
public class Fonacot_Cuentas_Por_Cobrar implements Serializable{
    @Id
    ...
    private Double retencion_nom;
    private Double retencion_vac;
    private Double devolucion;
    private Double solicitado_fonacot;
    private Double pago_fonacot;

    public Fonacot_Cuentas_Por_Cobrar() {
        super();
    }

    public Fonacot_Cuentas_Por_Cobrar(Integer id_cuentas_cobrar, Trabajador trabajador, Cat_Tipo_Nomina cat_Tipo_Nomina, Double saldo_inicial, Double saldo_actual, Double saldo_vacs, Double monto_pago, Integer numero_periodos_pago, Integer periodo_pago_actual, Double remanente_ultimo_pago, String criterio_pago, Double monto_criterio_pago, LocalDate fecha_inicio, LocalDate fecha_fin, Integer periodo_inicial, Integer destino, String referencia, Double saldo_actual_pr, Double remanente_ultimo_pago_pr, Integer estatus, Integer numero_deuda, LocalDate fecha_movimiento, LocalDate fecha_cancelacion_cuenta, String fecha_referencia, Double retencion_nom, Double retencion_vac, Double devolucion, Double solicitado_fonacot, Double pago_fonacot) {
        ...
        this.retencion_nom = retencion_nom;
        this.retencion_vac = retencion_vac;
        this.devolucion = devolucion;
        this.solicitado_fonacot = solicitado_fonacot;
        this.pago_fonacot = pago_fonacot;
    }
    ...
    public Double getRetencion_nom() {
        return retencion_nom;
    }

    public void setRetencion_nom(Double retencion_nom) {
        this.retencion_nom = retencion_nom;
    }
    ...
    public Double getSolicitado_fonacot() {
        return solicitado_fonacot;
    }

    public void setSolicitado_fonacot(Double solicitado_fonacot) {
        this.solicitado_fonacot = solicitado_fonacot;
    }

    public Double getPago_fonacot() {
        return pago_fonacot;
    }

    public void setPago_fonacot(Double pago_fonacot) {
        this.pago_fonacot = pago_fonacot;
    }

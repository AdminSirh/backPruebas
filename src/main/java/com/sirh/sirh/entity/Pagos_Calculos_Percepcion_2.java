 ...
 */
@Entity
@Table (name = "pagos_calculos_percepcion_2")
public class Pagos_Calculos_Percepcion_2 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_calculo_percepcion_2;
    ...
    public Pagos_Calculos_Percepcion_2() {
        super();
    }

    public Pagos_Calculos_Percepcion_2(Integer id_calculo_percepcion_2, Pagos_2 pagos_2, Integer periodo_generacion, Double monto, Double gravable, Cat_Incidencias cat_Incidencias) {
        this.id_calculo_percepcion_2 = id_calculo_percepcion_2;
    ...
    public Integer getId_calculo_percepcion_2() {
        return id_calculo_percepcion_2;
    }

    public void setId_calculo_percepcion_2(Integer id_calculo_percepcion_2) {
        this.id_calculo_percepcion_2 = id_calculo_percepcion_2;
    }

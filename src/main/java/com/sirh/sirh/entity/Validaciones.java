...
public class Validaciones implements Serializable{
    ...
    public Validaciones(Integer id_validaciones, Integer trabajador_id, Integer con_contrato_si_no, Integer activo_en_nomina_si_no, Integer activo_en_personal_si_no, Integer habilita_si_no, Integer sancion_si_no) {

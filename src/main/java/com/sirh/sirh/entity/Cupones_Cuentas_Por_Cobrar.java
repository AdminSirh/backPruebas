 ...
 */
@Entity
@Table(name = "cupones_cuentas_por_cobrar")
public class Cupones_Cuentas_Por_Cobrar implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_cupones_cuentas_cobrar;
    ...
    public Integer getId_cupones_cuentas_cobrar() {
        return id_cupones_cuentas_cobrar;
    }

    public void setId_cupones_cuentas_cobrar(Integer id_cupones_cuentas_cobrar) {
        this.id_cupones_cuentas_cobrar = id_cupones_cuentas_cobrar;
    }

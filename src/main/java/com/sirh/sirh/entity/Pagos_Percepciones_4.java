 ...
 */
@Entity
@Table(name = "pagos_percepciones_4")
public class Pagos_Percepciones_4 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_percepcion_4;
    @NotEmpty
    ...
    public Pagos_Percepciones_4() {
        super();
    }

    public Pagos_Percepciones_4(Integer id_pago_percepcion_4, Cat_Incidencias cat_Incidencias, Integer periodo_generacion, Double valor, Pagos_4 pagos_4) {
        this.id_pago_percepcion_4 = id_pago_percepcion_4;
    ...
    public Integer getId_pago_percepcion_4() {
        return id_pago_percepcion_4;
    }

    public void setId_pago_percepcion_4(Integer id_pago_percepcion_4) {
        this.id_pago_percepcion_4 = id_pago_percepcion_4;
    }

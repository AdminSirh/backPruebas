 ...
 */
@Entity
@Table(name = "captura_semanal_paseos_laborados_ra_15")
public class Captura_Semanal_Paseos_Laborados_RA15 implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_paseos_laborados;
    ...
    public Integer getId_paseos_laborados() {
        return id_paseos_laborados;
    }

    public void setId_paseos_laborados(Integer id_paseos_laborados) {
        this.id_paseos_laborados = id_paseos_laborados;
    }

 ...
 */
@Entity
@Table(name = "auxilio_cuentas_por_cobrar")
public class Auxilio_Cuentas_Por_Cobrar implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_auxilio_cuentas_cobrar;
    ...
    public Integer getId_auxilio_cuentas_cobrar() {
        return id_auxilio_cuentas_cobrar;
    }

    public void setId_auxilio_cuentas_cobrar(Integer id_auxilio_cuentas_cobrar) {
        this.id_auxilio_cuentas_cobrar = id_auxilio_cuentas_cobrar;
    }

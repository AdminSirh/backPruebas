...
@Entity
@Table (name = "pagos_5")
public class Pagos_5 {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_5;
    ...
    public Pagos_5(Integer id_pago_5, Trabajador trabajador, Double monto, Integer periodo_aplicacion, Integer anio_aplicacion, Integer puesto_temporal_id, Double sueldo_temporal, Double sueldo_temporal_mensual, LocalDate fecha_registro, Integer taxi_electrico, Double sdi, Cat_Puesto cat_Puesto) {
        this.id_pago_5 = id_pago_5;
    ...
    public Integer getId_pago_5() {
        return id_pago_5;
    }

    public void setId_pago_5(Integer id_pago_5) {
        this.id_pago_5 = id_pago_5;
    }

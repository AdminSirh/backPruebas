 ...
 */
@Entity
@Table(name = "pagos_deducciones_3")
public class Pagos_Deducciones_3 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_deduccion_3;
    @NotEmpty
    ...
    public Pagos_Deducciones_3() {
        super();
    }

    public Pagos_Deducciones_3(Integer id_pago_deduccion_3, Cat_Incidencias cat_Incidencias, Integer periodo_generacion, Double valor, Pagos_3 pagos_3) {
        this.id_pago_deduccion_3 = id_pago_deduccion_3;
    ...
    public Integer getId_pago_deduccion_3() {
        return id_pago_deduccion_3;
    }

    public void setId_pago_deduccion_3(Integer id_pago_deduccion_3) {
        this.id_pago_deduccion_3 = id_pago_deduccion_3;
    }

...
public class Vacaciones implements Serializable{
    ...
    public Vacaciones(Integer id_vacaciones, Integer trabajador_id, Integer expediente, Integer dias_paseos, LocalDate fecha_inicio, LocalDate fecha_fin, Double periodo_vacacional, String antiguedad, Integer dias_totales, Integer estado_vacaciones_id, Integer dias_disponibles, Integer periodo_aplicacion, Integer motivo_cancelacion, String referencia_cancelacion, LocalDate fecha_inicio_anio_periodo_vacacional, LocalDate fecha_fin_anio_periodo_vacacional, Double dias_proporcionales, String observaciones, LocalDate fecha_movimiento, Integer periodo_aplicacion_fin, Integer a_discontinua, Integer genera_pago_si_no, Integer incidencias_id) {

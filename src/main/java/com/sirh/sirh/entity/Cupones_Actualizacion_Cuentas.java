 ...
 */
@Entity
@Table(name = "cupones_actualizacion_cuentas")
public class Cupones_Actualizacion_Cuentas implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_cupones_actualizacion_cuentas;
    
    private Integer cupones_cuentas_cobrar_id;
    ...
    public Cupones_Actualizacion_Cuentas() {
        super();
    }

    public Cupones_Actualizacion_Cuentas(Integer id_cupones_actualizacion_cuentas, Integer cupones_cuentas_cobrar_id, Integer concepto, Double saldo_anterior, Double abono, Double saldo_actual, Integer periodo, Cat_Tipo_Nomina cat_Tipo_Nomina, Integer estatus, Double saldo_ant_vac, Double abono_vac, Double descto_norm, Trabajador trabajador, LocalDate fecha_movimiento) {
        this.id_cupones_actualizacion_cuentas = id_cupones_actualizacion_cuentas;
        this.cupones_cuentas_cobrar_id = cupones_cuentas_cobrar_id;
    ...
    public Integer getId_cupones_actualizacion_cuentas() {
        return id_cupones_actualizacion_cuentas;
    }

    public void setId_cupones_actualizacion_cuentas(Integer id_cupones_actualizacion_cuentas) {
        this.id_cupones_actualizacion_cuentas = id_cupones_actualizacion_cuentas;
    }

    public Integer getCupones_cuentas_cobrar_id() {
        return cupones_cuentas_cobrar_id;
    }

    public void setCupones_cuentas_cobrar_id(Integer cupones_cuentas_cobrar_id) {
        this.cupones_cuentas_cobrar_id = cupones_cuentas_cobrar_id;
    }

...
@Entity
@Table (name = "pagos_3")
public class Pagos_3 {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_3;
    ...
    public Pagos_3(Integer id_pago_3, Trabajador trabajador, Double monto, Integer periodo_aplicacion, Integer anio_aplicacion, Integer puesto_temporal_id, Double sueldo_temporal, Double sueldo_temporal_mensual, LocalDate fecha_registro, Integer taxi_electrico, Double sdi, Cat_Puesto cat_Puesto) {
        this.id_pago_3 = id_pago_3;
    ...
    public Integer getId_pago_3() {
        return id_pago_3;
    }

    public void setId_pago_3(Integer id_pago_3) {
        this.id_pago_3 = id_pago_3;
    }

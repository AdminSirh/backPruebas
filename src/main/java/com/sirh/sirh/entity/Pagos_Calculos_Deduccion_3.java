 ...
 */
@Entity
@Table (name = "pagos_calculos_deduccion_3")
public class Pagos_Calculos_Deduccion_3 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_calculo_deduccion_3;
    ...
    public Pagos_Calculos_Deduccion_3() {
        super();
    }

    public Pagos_Calculos_Deduccion_3(Integer id_calculo_deduccion_3, Pagos_3 pagos_3, Integer periodo_generacion, Double monto, Double gravable, Cat_Incidencias cat_Incidencias) {
        this.id_calculo_deduccion_3 = id_calculo_deduccion_3;
    ...
    public Integer getId_calculo_deduccion_3() {
        return id_calculo_deduccion_3;
    }

    public void setId_calculo_deduccion_3(Integer id_calculo_deduccion_3) {
        this.id_calculo_deduccion_3 = id_calculo_deduccion_3;
    }

 ...
 */
@Entity
@Table(name = "pagos_percepciones_5")
public class Pagos_Percepciones_5 implements Serializable{
    @Id
    ...
    public Pagos_Percepciones_5() {
        super();
    }

    public Pagos_Percepciones_5(Integer id_pago_percepcion_1, Cat_Incidencias cat_Incidencias, Integer periodo_generacion, Double valor, Pagos_5 pagos_5) {

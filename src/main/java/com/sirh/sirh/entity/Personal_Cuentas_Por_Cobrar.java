 ...
 */
@Entity
@Table (name="personal_cuentas_por_cobrar")
public class Personal_Cuentas_Por_Cobrar implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_personal_cuentas_cobrar;
    ...
    public Personal_Cuentas_Por_Cobrar() {
        super();
    }

    public Personal_Cuentas_Por_Cobrar(Integer id_personal_cuentas_cobrar, Trabajador trabajador, Cat_Tipo_Nomina cat_Tipo_Nomina, Double saldo_inicial, Double saldo_actual, Double saldo_vacs, Double monto_pago, Integer numero_periodos_pago, Integer periodo_pago_actual, Double remanente_ultimo_pago, String criterio_pago, Double monto_criterio_pago, LocalDate fecha_inicio, LocalDate fecha_fin, Integer periodo_inicial, Integer destino, String referencia, Double saldo_actual_pr, Double remanente_ultimo_pago_pr, Integer estatus, Integer numero_deuda, LocalDate fecha_movimiento, LocalDate fecha_cancelacion_cuenta, String fecha_referencia, Double retencion_norm, Double retencion_vac, Double devolucion, Integer deposito) {
        this.id_personal_cuentas_cobrar = id_personal_cuentas_cobrar;
    ...
    public Integer getId_personal_cuentas_cobrar() {
        return id_personal_cuentas_cobrar;
    }

    public void setId_personal_cuentas_cobrar(Integer id_personal_cuentas_cobrar) {
        this.id_personal_cuentas_cobrar = id_personal_cuentas_cobrar;
    }

 ...
 */
@Entity
@Table(name = "historico_incapacidades")
public class Historico_Incapacidades implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_incapacidad_historico;
    ...
    public Historico_Incapacidades() {
    }

    public Historico_Incapacidades(Integer id_incapacidad_historico, Integer id_historico, String folio, Integer expediente, LocalDateTime fecha_inicial, LocalDateTime fecha_final, Integer dias_incapacidad, Cat_Motivo_Incapacidad cat_Motivo_Incapacidad, Cat_Tipo_Incapacidad cat_Tipo_Incapacidad, Double porcentaje_cobro_imss, Double salario_diario_integrado, Double subtotal, Double importe_cobrar_imss, Double saldo_importe_cobrar_imss, Integer dias_cotizables, String st1, String st2, String status, String origen, Integer autorizar, Integer pagada, Double diferencia_favor, LocalDateTime fecha_autorizacion, Integer expediente_autorizacion, LocalDateTime fecha_movimiento, String cadena_pago, Cat_Tipo_Riesgo_Incapacidad cat_Tipo_Riesgo_Incapacidad, Cat_Tipo_Secuelas_Incapacidad cat_Tipo_Secuelas_Incapacidad, Cat_Tipo_Control_Incapacidad cat_Tipo_Control_Incapacidad, LocalDateTime fecha_cambio) {
        this.id_incapacidad_historico = id_incapacidad_historico;
    ...
    public Integer getId_incapacidad_historico() {
        return id_incapacidad_historico;
    }

    public void setId_incapacidad_historico(Integer id_incapacidad_historico) {
        this.id_incapacidad_historico = id_incapacidad_historico;
    }

 ...
 */
@Entity
@Table (name = "historico_credito_infonavit")
public class Historico_Credito_Infonavit implements Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_historico_credito_infonavit; 
    
    private Integer trabajador_id;
    private Integer credito_infonavit_id; 
    ...
    public Historico_Credito_Infonavit() {
    }

    public Historico_Credito_Infonavit(Integer id_historico_credito_infonavit, Integer trabajador_id, Integer credito_infonavit_id, String numero_de_credito, Cat_Tipo_Credito cat_tipo_credito, String descripcion_tipo_credito, LocalDate fecha_de_recepcion, LocalDate fecha_de_aplicacion, Cat_Estatus_Credito cat_Estatus_Credito, LocalDate fecha_movimiento, Cat_Motivo_Baja cat_Motivo_Baja, LocalDate fecha_evento) {
        this.id_historico_credito_infonavit = id_historico_credito_infonavit;
        this.trabajador_id = trabajador_id;
        this.credito_infonavit_id = credito_infonavit_id;
    ...
    public Integer getId_historico_credito_infonavit() {
        return id_historico_credito_infonavit;
    }

    public void setId_historico_credito_infonavit(Integer id_historico_credito_infonavit) {
        this.id_historico_credito_infonavit = id_historico_credito_infonavit;
    }
    ...
    public Integer getCredito_infonavit_id() {
        return credito_infonavit_id;
    }

    public void setCredito_infonavit_id(Integer credito_infonavit_id) {
        this.credito_infonavit_id = credito_infonavit_id;
    }

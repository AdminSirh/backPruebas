...
@Entity
@Table (name = "pagos_1")
public class Pagos_1 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_1;
    ...
    public Pagos_1(Integer id_pago_1, Trabajador trabajador, Double monto, Integer periodo_aplicacion, Integer anio_aplicacion, Integer puesto_temporal_id, Double sueldo_temporal, Double sueldo_temporal_mensual, LocalDate fecha_registro, Integer taxi_electrico, Double sdi, Cat_Puesto cat_Puesto) {
        this.id_pago_1 = id_pago_1;
    ...
    public Integer getId_pago_1() {
        return id_pago_1;
    }

    public void setId_pago_1(Integer id_pago_1) {
        this.id_pago_1 = id_pago_1;
    }

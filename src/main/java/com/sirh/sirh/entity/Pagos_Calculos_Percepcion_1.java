 ...
 */
@Entity
@Table (name = "pagos_calculos_percepcion_1")
public class Pagos_Calculos_Percepcion_1 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_calculo_percepcion_1;
    ...
    public Pagos_Calculos_Percepcion_1() {
        super();
    }

    public Pagos_Calculos_Percepcion_1(Integer id_calculo_percepcion_1, Pagos_1 pagos_1, Integer periodo_generacion, Double monto, Double gravable, Cat_Incidencias cat_Incidencias) {
        this.id_calculo_percepcion_1 = id_calculo_percepcion_1;
    ...
    public Integer getId_calculo_percepcion_1() {
        return id_calculo_percepcion_1;
    }

    public void setId_calculo_percepcion_1(Integer id_calculo_percepcion_1) {
        this.id_calculo_percepcion_1 = id_calculo_percepcion_1;
    }

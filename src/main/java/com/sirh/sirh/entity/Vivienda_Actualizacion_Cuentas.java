 ...
 */
@Entity
@Table(name = "vivienda_actualizacion_cuentas")
public class Vivienda_Actualizacion_Cuentas implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_vivienda_actualizacion_cuentas;
    
    private Integer vivienda_cuentas_cobrar_id;
    ...
    public Vivienda_Actualizacion_Cuentas() {
        super();
    }

    public Vivienda_Actualizacion_Cuentas(Integer id_vivienda_actualizacion_cuentas, Integer vivienda_cuentas_cobrar_id, Integer concepto, Double saldo_anterior, Double abono, Double saldo_actual, Integer periodo, Cat_Tipo_Nomina cat_Tipo_Nomina, Integer estatus, Double saldo_ant_vac, Double abono_vac, Double descto_norm, Trabajador trabajador, LocalDate fecha_movimiento) {
        this.id_vivienda_actualizacion_cuentas = id_vivienda_actualizacion_cuentas;
        this.vivienda_cuentas_cobrar_id = vivienda_cuentas_cobrar_id;
    ...
    public Integer getId_vivienda_actualizacion_cuentas() {
        return id_vivienda_actualizacion_cuentas;
    }

    public void setId_vivienda_actualizacion_cuentas(Integer id_vivienda_actualizacion_cuentas) {
        this.id_vivienda_actualizacion_cuentas = id_vivienda_actualizacion_cuentas;
    }

    public Integer getVivienda_cuentas_cobrar_id() {
        return vivienda_cuentas_cobrar_id;
    }

    public void setVivienda_cuentas_cobrar_id(Integer vivienda_cuentas_cobrar_id) {
        this.vivienda_cuentas_cobrar_id = vivienda_cuentas_cobrar_id;
    }

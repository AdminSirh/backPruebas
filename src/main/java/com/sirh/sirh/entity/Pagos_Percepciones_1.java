 ...
 */
@Entity
@Table(name = "pagos_percepciones_1")
public class Pagos_Percepciones_1 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_percepcion_1;
    @NotEmpty
    ...
    public Pagos_Percepciones_1() {
        super();
    }

    public Pagos_Percepciones_1(Integer id_pago_percepcion_1, Cat_Incidencias cat_Incidencias, Integer periodo_generacion, Double valor, Pagos_1 pagos_1) {
        this.id_pago_percepcion_1 = id_pago_percepcion_1;
    ...
    public Integer getId_pago_percepcion_1() {
        return id_pago_percepcion_1;
    }

    public void setId_pago_percepcion_1(Integer id_pago_percepcion_1) {
        this.id_pago_percepcion_1 = id_pago_percepcion_1;
    }

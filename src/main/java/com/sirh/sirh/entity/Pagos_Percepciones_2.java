 ...
 */
@Entity
@Table(name = "pagos_percepciones_2")
public class Pagos_Percepciones_2 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_pago_percepcion_2;
    @NotEmpty
    ...
    public Pagos_Percepciones_2() {
        super();
    }

    public Pagos_Percepciones_2(Integer id_pago_percepcion_2, Cat_Incidencias cat_Incidencias, Integer periodo_generacion, Double valor, Pagos_2 pagos_2) {
        this.id_pago_percepcion_2 = id_pago_percepcion_2;
    ...
    public Integer getId_pago_percepcion_2() {
        return id_pago_percepcion_2;
    }

    public void setId_pago_percepcion_2(Integer id_pago_percepcion_2) {
        this.id_pago_percepcion_2 = id_pago_percepcion_2;
    }

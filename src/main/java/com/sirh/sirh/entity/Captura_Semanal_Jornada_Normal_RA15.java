 ...
 */
@Entity
@Table(name = "captura_semanal_jornada_normal_ra_15")
public class Captura_Semanal_Jornada_Normal_RA15 implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_jornada_normal;
    ...
    public Integer getId_jornada_normal() {
        return id_jornada_normal;
    }

    public void setId_jornada_normal(Integer id_jornada_normal) {
        this.id_jornada_normal = id_jornada_normal;
    }

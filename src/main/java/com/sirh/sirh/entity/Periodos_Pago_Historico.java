 ...
 */
@Entity
@Table(name = "periodos_pago_historico")
public class Periodos_Pago_Historico implements Serializable{
   
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_periodo_historico;
    ...
    public Integer getId_periodo_historico() {
        return id_periodo_historico;
    }

    public void setId_periodo_historico(Integer id_periodo_historico) {
        this.id_periodo_historico = id_periodo_historico;
    }

 ...
 */
@Entity
@Table (name = "pagos_calculos_deduccion_4")
public class Pagos_Calculos_Deduccion_4 implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_calculo_deduccion_4;
    ...
    public Pagos_Calculos_Deduccion_4() {
        super();
    }

    public Pagos_Calculos_Deduccion_4(Integer id_calculo_deduccion_4, Pagos_4 pagos_4, Integer periodo_generacion, Double monto, Double gravable, Cat_Incidencias cat_Incidencias) {
        this.id_calculo_deduccion_4 = id_calculo_deduccion_4;
    ...
    public Integer getId_calculo_deduccion_4() {
        return id_calculo_deduccion_4;
    }

    public void setId_calculo_deduccion_4(Integer id_calculo_deduccion_4) {
        this.id_calculo_deduccion_4 = id_calculo_deduccion_4;
    }

 ...
 */
@Entity
@Table (name = "pagos_calculos_percepcion_5")
public class Pagos_Calculos_Percepcion_5 implements Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id_calculo_percepcion_5;
    ...
    public Pagos_Calculos_Percepcion_5() {
        super();
    }

    public Pagos_Calculos_Percepcion_5(Integer id_calculo_percepcion_5, Pagos_5 pagos_5, Integer periodo_generacion, Double monto, Double gravable, Cat_Incidencias cat_Incidencias) {
        this.id_calculo_percepcion_5 = id_calculo_percepcion_5;
    ...
    public Integer getId_calculo_percepcion_5() {
        return id_calculo_percepcion_5;
    }

    public void setId_calculo_percepcion_5(Integer id_calculo_percepcion_5) {
        this.id_calculo_percepcion_5 = id_calculo_percepcion_5;
    }

...
function tabla() {
    $tablaTrabajadores = $('#tabla_Trabajadores').dataTable({
        ...
        columns: [
            ...
            {data: "", sTitle: "Adeudo Vivienda", width: 100, visible: true, render: function (d, t, r) {
                    var he;
...
function comparaFechasCorte() {
    ...
    $.ajax({
        type: "GET",
        url: "abonoVivienda/listarFechasCorteDescuentos",
        dataType: 'json',
...
function descuentos() {
    $.ajax({
        type: "GET",
        url: "abonoVivienda/listarCuentasActivasVivienda",
        dataType: 'json',
        success: function (data) {
            comparaFechasCorte();

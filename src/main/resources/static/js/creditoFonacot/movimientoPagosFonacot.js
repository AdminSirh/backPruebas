...
function listarPagos(trabajador_id){
    ...
    "ajax": {
        //El controlador es el mismo para credito Fonacot y para Credito Personal. No es necesario cambiarlo
        url: 'creditoFonacot/listarCuentasActuales/'+trabajador_id + "/" + id_cuenta_por_cobrar,
        method: 'GET',
        dataSrc: ''
    },
    responsive: true,

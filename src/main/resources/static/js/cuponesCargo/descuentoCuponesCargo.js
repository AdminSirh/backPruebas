...
function guardarDosificacion(){
    ...
    $.ajax({
        type: "POST",
        url: "cuponesCargo/guardarDescuentoCupones",
...
function eliminaCuenta(){
    ...
    $.ajax({
        type: "POST",
        url: "cuponesCargo/estatusCuentaPorCobrar/" + trabajador_id,
...
$("#saldarCuentaModal").submit(function (e) {
    ...
    var datos = {"monto_pago": monto_pago, "trabajador_id": trabajador_id, "periodo_pago":periodo_saldar_cuenta, "saldo_deuda":saldo_actual, "cuentas_Por_Cobrar":{"id_cupones_cuentas_cobrar":id_cuenta_por_cobrar}, "justificacion":justificacion};
    
    $.ajax({
        type: "POST",
        url: "cuponesCargo/guardarRegistroPagosDeudas",
        dataType: 'json',
        contentType: "application/json",
        data: JSON.stringify(datos),
        success: function (data) {
...
function actualizaEstatusCuentaSaldada(id_cuenta_por_cobrar,trabajador_id){
    $.ajax({
        type: "POST",
        url: "cuponesCargo/estatusCuentaSaldada/" + id_cuenta_por_cobrar,

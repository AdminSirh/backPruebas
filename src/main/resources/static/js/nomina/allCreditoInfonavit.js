...
$tablaTrabajadores = $('#tabla_Trabajadores').dataTable({
    ...
    columns: [
        ...
        {data: "", sTitle: "Importacion de incidencias", width: 100, visible: true, render: function (d, t, r) {
                var he;
                he = '<button type="button" class="btn btn-outline-primary" onclick="GuardaCredito(' + r.id_trabajador + ')"><span class="fa fa-edit"></span>Captura de Credito</button>';
                return he;
            }
        }]
});
...
function GuardaCredito(id_trabajador) {
    window.location.href = 'capturaCreditoInfonavit?id_trabajador=' + id_trabajador;
}

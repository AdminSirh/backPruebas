...
$tablaTrabajadores = $('#tabla_Trabajadores').dataTable({
    ...
    columns: [
        ...
        {data: "", sTitle: "Importacion de incidencias", width: 100, visible: true, render: function (d, t, r) {
                var he;
                he = '<button type="button" class="btn btn-outline-primary" onclick="incidenciasAutomaticas(' + r.id_trabajador + ')"><span class="fa fa-edit"></span>Incidencias</button>';
                return he;
            }
        }]
});
...
function incidenciasAutomaticas(id_trabajador) {
    window.location.href = 'incidenciasAutomaticas?id_trabajador=' + id_trabajador;
}
